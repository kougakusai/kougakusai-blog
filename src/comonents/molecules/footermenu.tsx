...
export default function FooterMenu() {
  return (
    <div className="flex flex-col lg:flex-row divide-solid divide-white divide-x-0 lg:divide-x-2 divide-y-0 space-y-1 lg:space-y-0 lg:mb-8 justify-items-center justify-start text-left justify-items-start text-sm h-full w-full">
