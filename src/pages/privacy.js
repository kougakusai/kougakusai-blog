      ...
      <Layout>
        <div>
          ...
          <div className="sm:ml-50">
            <p>
              こうがく祭実行委員会（以下，「当委員会」といいます。）は，本ウェブサイト上（以下,「当サイト」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
            </p>
            {/* <p>
            ...
            <div className="mt-3 mb-5">
              ...
              <p>
                ...
                お客さまからお預かりした個人情報は、当委員会からのご質問に対する回答等に利用いたします。
              </p>
            </div>
